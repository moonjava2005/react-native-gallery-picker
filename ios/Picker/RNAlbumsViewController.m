...
@interface RNAlbumsViewController () <PHPhotoLibraryChangeObserver>
...
@implementation RNAlbumsViewController
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    self.navigationItem.title = NSLocalizedStringFromTableInBundle(@"albums.title", @"RNImagePicker", self.imagePickerController.assetBundle, nil);
...
{
    RNAssetsViewController *assetsViewController = segue.destinationViewController;
...
{
    RNAlbumCell *cell = [tableView dequeueReusableCellWithIdentifier:@"AlbumCell" forIndexPath:indexPath];
